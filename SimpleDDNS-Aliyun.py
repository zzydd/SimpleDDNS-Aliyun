...
def GetRecordInfo(domain_main, sub_domain):
    #发送请求
    try:
...
while MainMode:
    ...
    for IPv4 in IPv4_List:
        ...
        #获取DNS记录信息 (记录ID,记录值)
        record_id, record_value = GetRecordInfo(main_domain,sub_domain)
    ...
    try:
        ...
        print(f'[{DatetimeNow()}] [信息] 程序将在{UpdateDelay}秒后再次检查更新')
    except ValueError:
